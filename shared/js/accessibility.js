...
(function () {
  ...
  function createStyle() {
    ...
    style.textContent = [
      ...
      'color:#fff;font-size:var(--text-2xl);cursor:pointer;display:flex;align-items:center;justify-content:center;',
      ...
      '.a11y-title{font-size:var(--text-sm);font-weight:700;margin-bottom:16px;display:flex;',
      'align-items:center;gap:8px;color:inherit;}',
      '.a11y-row{display:flex;justify-content:space-between;align-items:center;',
      'margin-bottom:12px;font-size:var(--text-sm);color:inherit;}',
      ...
      'background:transparent;color:inherit;font-size:var(--text-xs);cursor:pointer;transition:all 0.2s ease;}',
